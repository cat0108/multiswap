...
def process_file(input_file):
    ...
    # Calculate the average of every ten times
    averages = [average_time(times[i:i+10]) for i in range(0, len(times), 10) if len(times[i:i+10]) == 10]
...
if __name__ == "__main__":
    directory_path = "./testoutcome/ten_times"  # 目标目录路径
